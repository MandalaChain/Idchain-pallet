...
mod calculate_parachain_head_storage_key {
	...
	#[test]
	fn calculate_parachain_head_storage_key_successful_parachain_mainnet_parachain() {
		assert_eq!(
	...
	#[test]
	fn calculate_parachain_head_storage_key_successful_parachain_testnet_parachain() {
		assert_eq!(
...
mod calculate_dip_identity_commitment_storage_key_for_runtime {
	...
	#[test]
	fn calculate_dip_identity_commitment_storage_key_for_runtime_successful_parachain_testnet_parachain() {
		use idchain_parachain_testnet_runtime::Runtime as ParachainTestnetRuntime;
		use sp_core::crypto::Ss58Codec;
		use uid_core::DidIdentifierOf;

		assert_eq!(
			calculate_dip_identity_commitment_storage_key_for_runtime::<ParachainTestnetRuntime>(&DidIdentifierOf::<ParachainTestnetRuntime>::from_ss58check("4s3jpR7pzrUdhVUqHHdWoBN6oNQHBC7WRo7zsXdjAzQPT7Cf").unwrap(), 0).0,
