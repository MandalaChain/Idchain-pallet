...
use hex_literal::hex;
use idchain_parachain_testnet_runtime::Runtime as ParachainTestnetRuntime;
...
impl DipCallOriginFilter<RuntimeCall> for FilterNothing {
	...
	type OriginInfo = Vec<
		RevealedDidKey<
			KeyIdOf<ParachainTestnetRuntime>,
			BlockNumberFor<ParachainTestnetRuntime>,
			<ParachainTestnetRuntime as frame_system::Config>::AccountId,
		>,
	>;
	type Success = ();
...
impl pallet_dip_consumer::Config for TestRuntime {
	...
	type Identifier = <ParachainTestnetRuntime as uid_core::Config>::DidIdentifier;
...
pub(crate) fn subject() -> DidIdentifierOf<ParachainTestnetRuntime> {
	DidIdentifierOf::<ParachainTestnetRuntime>::from_ss58check("4rTs9KCbLf28yUVsMo5t39ssfW4rPsaqq2UqeZi3hwYLpg3Q")
		.unwrap()
}
...
pub(crate) fn cross_chain_proof_with_authentication_key_and_web3_name() -> ParachainDipDidProof<
	...
	<ParachainTestnetRuntime as frame_system::Config>::AccountId,
	BlockNumberFor<ParachainTestnetRuntime>,
	Web3NameOf<ParachainTestnetRuntime>,
	LinkableAccountId,
...
> {
	...
	] }, signature: TimeBoundDidSignature::new(uid_core::DidSignature::Sr25519(sr25519::Signature(hex!("3cd5e72f04d248e5155bfdabb94c308a88368db63a8a0cafc15fb3204a709b07da028cf85bd450d9a2bdb6679f2b07ac69188101185ab3acd9f41419cbfb3c81"))), SIGNATURE_VALID_UNTIL) }
}
