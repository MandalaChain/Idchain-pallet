...
use uid_core::{did_details::DidPublicKeyDetails, DidVerificationKeyRelationship};
	...
	fn default() -> Self {
		let default_keys = sp_std::vec![RevealedDidKey {
			...
			details: DidPublicKeyDetails {
				key: uid_core::did_details::DidVerificationKey::Ed25519(sp_core::ed25519::Public::from_raw([0u8; 32]))
					.into(),
