...
use uid_core::{did_details::DidPublicKeyDetails, AccountIdOf, BalanceOf, KeyIdOf};
...
impl<T: uid_core::Config> From<uid_core::did_details::DidDetails<T>>
	for DidDetails<KeyIdOf<T>, BlockNumberFor<T>, AccountIdOf<T>, BalanceOf<T>>
{
	fn from(did_details: uid_core::did_details::DidDetails<T>) -> Self {
		Self {
