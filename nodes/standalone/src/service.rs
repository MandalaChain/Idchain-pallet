...
use idchain_standalone_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		idchain_standalone_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		idchain_standalone_runtime::native_version()
	}
}
