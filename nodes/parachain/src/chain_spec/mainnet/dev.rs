...
use crate::chain_spec::{
	mainnet::{ChainSpec, SAFE_XCM_VERSION},
...
pub(crate) fn generate_chain_spec(relaychain_name: &str) -> ChainSpec {
	...
	.with_name("IDCHAIN Parachain-Mainnet Development")
	.with_id("idchain_parachain_mainnet_dev")
