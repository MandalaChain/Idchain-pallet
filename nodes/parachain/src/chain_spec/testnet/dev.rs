...
use idchain_parachain_testnet_runtime::{
	BalancesConfig, CouncilConfig, ParachainInfoConfig, PolkadotXcmConfig, RuntimeGenesisConfig, SessionConfig,
	SessionKeys, SudoConfig, TechnicalCommitteeConfig, WASM_BINARY,
};
...
pub(crate) fn generate_chain_spec(relaychain_name: &str) -> ChainSpec {
	...
	ChainSpec::builder(
		...
		Extensions {
			...
			para_id: IDCHAIN_PARA_ID,
		},
	)
	.with_name("IDCHAIN Parachain-Testnet Development")
	.with_id("idchain_parachain_testnet_dev")
	.with_chain_type(ChainType::Development)
	.with_properties(get_properties("IDCHAIN", 15, 38))
...
fn generate_genesis_state() -> RuntimeGenesisConfig {
	...
	RuntimeGenesisConfig {
		...
		parachain_info: ParachainInfoConfig {
			parachain_id: IDCHAIN_PARA_ID.into(),
			..Default::default()
		},
