...
use verification::VerificationAccessControl;
...
impl<AttesterId, DelegationAc, DelegationId, Ctype, ClaimHash>
	VerificationAccessControl<AttesterId, AuthorizationId<DelegationId>, Ctype, ClaimHash> for PalletAuthorize<DelegationAc>
where
	DelegationAc: VerificationAccessControl<AttesterId, DelegationId, Ctype, ClaimHash>,
{
